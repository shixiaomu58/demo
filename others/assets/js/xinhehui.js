...
<<<<<<< HEAD
    $(".news-user-frame li").mouseover(function(){
        if (!($(this).is(":animated")&&$(this).hasclass("isLoaded"))){
            $(this).siblings("li").animated({"width":"150px"},"fast");//将其余同胞li元素设置动画：宽度快速变为150px.
            $(this).siblings("li").find("h4").hide();//将其余同胞li元素下面的h4设置为隐藏
            $(this).animated({"width":"422px"},"fast");//将当前li元素设置动画：宽度快速变为422px.
            $(this).find("h4").show();//将当前li元素下面的h4设置为隐藏

            $(this).find(".user-play-bg-name").animated({"opacity": "0"});//当前左下角文字设为透明即隐藏
            ...
            $(this).siblings("li").find(".user-play-bg-name").animated({"opacity": "1"});//当前左下角文字设为透明即隐藏
...
>>>>>>> 375c97c807e4be37909706df3af88239398fb8d5
